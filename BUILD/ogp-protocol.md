...
-   `og:determiner` - The word that appears before this object's title in a sentence. An [enum](#enum) of (a, an, the, "", auto). If `auto` is chosen, the consumer of your data should choose between "a" or "an". Default is "" (blank).
...
[`payment.link`](#type_payment) - Namespace URI: [`https://ogp.me/ns/payment#`](http://ogp.me/ns/payments) 🚧 **Beta only**
...
[`profile`](#type_profile) - Namespace URI: [`http://ogp.me/ns/profile#`](http://ogp.me/ns/profile)
